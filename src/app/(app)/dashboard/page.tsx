      ...
      <div className="mb-12">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link
            ...
            className="font-anthropic-sans font-semibold text-[13px] border border-slate-dark text-slate-dark px-5 py-2.5 rounded-lg hover:bg-slate-dark hover:text-white transition-all flex items-center gap-2"
          >
